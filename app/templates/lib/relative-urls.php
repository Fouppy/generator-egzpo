 ...
 */
function egzpo_root_relative_url($input) {
...
if (egzpo_enable_root_relative_urls()) {
  ...
  add_filters($root_rel_filters, 'egzpo_root_relative_url');
}